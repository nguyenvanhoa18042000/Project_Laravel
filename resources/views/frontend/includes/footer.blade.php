                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            ...
                            <div class="shipping-text">
                                ...
                                <p>Hoàn trả miễn phí và xem thanh toán cho ngày giao hàng.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            ...
                            <div class="shipping-text">
                                ...
                                <p>Với các phương thức thanh toán an toàn và phổ biến nhất trên thế giới.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Li's Shipping Inner Box Area End Here -->
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                        <div class="li-shipping-inner-box">
                            ...
                            <div class="shipping-text">
                                ...
                                <p>Bảo vệ người mua của chúng tôi bao gồm việc mua hàng của bạn</p>
                            </div>
                        </div>
                    </div>
                    <!-- Li's Shipping Inner Box Area End Here -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <ul class="des">
                            <li>
                                <span>Địa chỉ: </span>
                                Số 2 ngõ 118 Trương Định, Hai Bà Trưng, Hà Nội
                            </li>
                            <li>
                                <span>SĐT: </span>
                                <a href="#">0956888888 hoặc 0939246888</a>
                            </li>
                            <li>
                                <span>Email: </span>
                                <a href="mailto://info@yourdomain.com">nguyenvanhoa@gmail.com</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="footer-block">
                            <h3 class="footer-block-title">Theo dõi qua</h3>
...
<div class="footer-static-bottom pt-30 pb-25">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
